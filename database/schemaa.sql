...
INSERT INTO `etudiants` (`id`, `userId`, `matricule`, `identifiantTemporaire`, `nom`, `prenom`, `annee`, `photoUrl`, `ecoleId`, `filiereId`, `whatsapp`, `additional_info`) VALUES
(1, 'USR-STUDENT-1001', 'UCAO-2025-201', 'TEMP-201', 'ADJIBADE', 'Leonce', 2, 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39', 1, 1, '+22961001201', 'Membre du club juridique'),
(2, 'USR-STUDENT-1002', NULL, 'TEMP-202', 'HOUNKPE', 'Ayaba', 1, 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1', 2, 2, '+22961001202', 'Ambassadrice orientation'),
(3, 'USR-STUDENT-1003', 'UCAO-2025-203', 'TEMP-203', 'DOSSA', 'Marcel', 3, 'https://images.unsplash.com/photo-1504593811423-6dd665756598', 1, 1, '+22961001203', 'Responsable logistique BDE'),
(4, 'USR-STUDENT-1004', 'UCAO-2025-204', 'TEMP-204', 'GNAHOUI', 'Sylvie', 2, 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?ixlib=rb-4.0.3', 1, 1, '+22961001204', 'Responsable communication BDE'),
(5, 'USR-STUDENT-1005', 'UCAO-2025-205', 'TEMP-205', 'TOKO', 'Idriss', 3, 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3', 1, 1, '+22961001205', 'Tuteur en algorithmique'),
(6, 'USR-STUDENT-1006', 'UCAO-2025-206', 'TEMP-206', 'KOUDJO', 'Prisca', 1, 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3', 1, 1, '+22961001206', 'Club robotique'),
(7, 'USR-STUDENT-1007', 'UCAO-2025-207', 'TEMP-207', 'AHOUANSOU', 'Mathieu', 2, 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3', 1, 1, '+22961001207', 'Mentor tutorat C++'),
(8, 'USR-STUDENT-1008', 'UCAO-2025-208', 'TEMP-208', 'AGOSSA', 'Clarisse', 3, 'https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?ixlib=rb-4.0.3', 1, 1, '+22961001208', 'Responsable vie associative'),
(9, 'USR-STUDENT-1009', 'UCAO-2025-209', 'TEMP-209', 'ADJOVI', 'Faustin', 2, 'https://images.unsplash.com/photo-1521579971123-1192931a1452?ixlib=rb-4.0.3', 1, 1, '+22961001209', 'Animateur hackathons'),
(10, 'USR-STUDENT-1010', 'UCAO-2025-210', 'TEMP-210', 'LOKO', 'Mireille', 1, 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?ixlib=rb-4.0.3', 1, 1, '+22961001210', 'Référente UX design'),
